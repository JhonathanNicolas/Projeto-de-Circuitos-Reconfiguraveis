...
HD_PWD='C:/Users/Jhon/Desktop/GMBH/GMBH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neoronio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neoronio.tcl
