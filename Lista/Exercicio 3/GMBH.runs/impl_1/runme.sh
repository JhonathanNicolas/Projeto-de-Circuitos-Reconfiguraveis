...
HD_PWD='C:/Users/Jhon/Desktop/GMBH/GMBH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neoronio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neoronio.tcl -notrace
