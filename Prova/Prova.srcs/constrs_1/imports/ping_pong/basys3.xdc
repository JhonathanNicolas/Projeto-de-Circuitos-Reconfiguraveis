...
set_property PACKAGE_PIN T3 [get_ports {adress[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {adress[0]}]
set_property PACKAGE_PIN T2 [get_ports {adress[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {adress[1]}]
set_property PACKAGE_PIN R3 [get_ports {adress[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {adress[2]}]
set_property PACKAGE_PIN W2 [get_ports {adress[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {adress[3]}]
set_property PACKAGE_PIN U1 [get_ports {adress[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {adress[4]}]
set_property PACKAGE_PIN T1 [get_ports {adress[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {adress[5]}]
set_property PACKAGE_PIN R2 [get_ports {adress[6]}]					
